...
public class NumberProcessor
{
    public void ProcessNumber(int number)
    {
        if (number % 2 == 0)
        {
            throw new EvenNumberException("EvenNumberException: Even numbers are not allowed.");
        }
        else
        {
            throw new OddNumberException("OddNumberException: Odd numbers are not allowed.");
        }
    }
}
